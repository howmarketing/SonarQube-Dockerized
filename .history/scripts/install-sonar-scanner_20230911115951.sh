...
SONAR_SCANNER_VERSION=${STRING//-cli-/}
echo ""
echo ""
echo ""
echo "-------------------------------------------"
...
Me ajuda com um regex para retirar o termo “-cli-” de uma string?
...
Sim, posso ajudar. O regex que você pode usar para retirar o termo "-cli-" de uma string é: 
...
Quero retirar o “-cli-“ da string abaixo em bashscript

`STRING=“sonar-scanner-cli-5.0.1.3006-macosx”`

Para criar uma nova string que fique assim: 

`STRING_2=“sonar-scanner-5.0.1.3006-macosx”`
...
Sim, posso ajudar. Para retirar o termo "-cli-" da string acima e criar uma nova string, você pode usar o seguinte comando no bashscript: 

STRING_2=${STRING//-cli-/}

Isso irá substituir o termo "-cli-" por nada, criando a nova string "sonar-scanner-5.0.1.3006-macosx".
