...
if [ -d "/tmp/sonar-scanner-cli-5.0.1.3006-macosx.zip" ]; then
    sudo rm /tmp/sonar-scanner-cli-5.0.1.3006-macosx.zip
fi
...
if [ -d "/var/opt/sonar-scanner-5.0.1.3006-macosx" ]; then
    sudo rm -rf /var/opt/sonar-scanner-5.0.1.3006-macosx
fi
sudo mv sonar-scanner-5.0.1.3006-macosx /var/opt
